...
namespace framework
{
	...
	{
	public:
		hue::c_color m_window_background = hue::c_color(15, 15, 15);
		hue::c_color m_element_base = hue::c_color(15, 15, 15);
		hue::c_color m_window_shadow = hue::c_color(15, 15, 15);
		hue::c_color m_window_bars = hue::c_color(20, 20, 20);
		hue::c_color m_text = hue::c_color(255, 255, 255);
		hue::c_color m_accent = hue::c_color(235, 100, 52);
		hue::c_color m_outline = hue::c_color(36, 36, 36);
	...
	enum class focus_priority : int {
		none = 0,
		hover,       // lowest — just mousing over
		interactive, // button, checkbox — needs click, releases immediately  
		persistent,  // dropdown, multibox, colorpicker — stays open until dismissed
		modal,       // popup — blocks everything below it
	};
